...
{
  /*
      * The AnswerHistory component displays the user's response history.
      * It uses state to get user data and response history.
      * If there is no user data, the user will be redirected to the main page.
      * Answer history is displayed as a list with questions, user data and correct answers.
      * The component also has responsive styles to look good on different devices.
  */
    ...
    <div className={style.card}>
      ...
      <div className={style['card-content']}>{answerHistory.map((answer, index) => (
        <div key={index}>
          ...
          <br />
          <p>{answer.question}</p>
          <p className={answer.userAnswer === answer.correctAnswer ? style.correct : style.incorrect}>Your answer: {answer.userAnswer}</p>
